...
<div>
    <div class="justify-content-center">
        <div class="">
            <div class="card p-2">
                <div class="card-header border d-flex justify-content-center">Adicionar Tarefa</div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tarefaName" name="tarefaName" class="form-control is-invalid" id="tarefaName"
                                placeholder="Tarefa">
                            <div class="invalid-feedback">
                                {{$errors->first('tarefaName')}}
                            </div @endif <input type="tarefaName" name="tarefaName" class="form-control "
                                id="tarefaName" placeholder="Tarefa">
                        </div>
                        <div class="form-group">
                            ...
                            </div @else <select class="form-control" id="tarefaTipo" name="tarefaTipo">
                            <option selected value="">Selecione</option>
                            @foreach ($tipos as $tipos)
                            <option value="{{$tipos->id}}">{{$tipos->tipo}}</option>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="tarefaDescreve" name="tarefaDescreve" class="form-control is-invalid"
                                id="tarefaDescreve" placeholder="Descrição">
                            <div class="invalid-feedback">
                                {{ $errors->first('tarefaDescreve') }}
                            </div>
                            @else
                            <input type="tarefaDescreve" name="tarefaDescreve" class="form-control" id="tarefaDescreve"
                        ...
                        <div class="form-group">
                            ...
                            <input type="subTarefas" name="subTarefas" class="form-control is-invalid" id="subTarefas"
                                placeholder="Etapas">
                            <div class="invalid-feedback">
                            ...
                            <div class="card-body" id="subTarefasAppend">
                                <div class="d-flex justify-content-between" id="subTarefas" name="">
                                    <input type="subTarefas" name="subTarefas[]" class="form-control mr-2"
                                        id="subTarefas" placeholder="Etapas">
                                    <button href="#" type="button" onclick="remove(this.parentNode.id)"><i
                                            class="material-icons">remove</i></button>
                                </div>
                            </div>
                            <div class="d d-flex justify-content-center p-2">
                                <label for="addSubtarefa">
                                    Adicionar nova Etapa
                                </label>
                                <button href="#" type="button" class="ml-3" name="addSubtarefa" onclick="toogle()"><i
